...
public class Evaluate {
	...
	public static void main(String[] args){
		...
		Data.sysout.println("Correct:       \t"+correct+"\t"+String.format(Locale.ROOT, "%.4f",correct*100f/trials)+"%");
		Data.sysout.println("Incorrect:     \t"+incorrect+"\t"+String.format(Locale.ROOT, "%.4f",incorrect*100f/trials)+"%");
		Data.sysout.println("False Positive:\t"+falsePositive+"\t"+String.format(Locale.ROOT, "%.4f",falsePositive*100f/trials)+"%");
		Data.sysout.println("False Negative:\t"+falseNegative+"\t"+String.format(Locale.ROOT, "%.4f",falseNegative*100f/trials)+"%");
